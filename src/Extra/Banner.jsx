...
const Banner = () => {
    return (
        <div className=" lg:flex rounded-none justify-center items-center bg-neutral ">
            <figure className='w-2/3'><img className='rounded-none' src={img} alt="Movie" /></figure>
            <div className="lg:w-3/4  text-white lg:pr-20 text-center p-5">
                ...
                <div className="pt-5">
                    <Link to={'https://pizza-burger-bulls.web.app/allfooditems'}><button className="btn bg-gradient-to-r from-yellow-500 via-purple-500 to-yellow-500 text-white font-bold text-xl">Show All Items</button></Link>
                </div>
            </div>
        </div>
    );
